...
language_schema = dxr.schema.Schema({
    ...
    "types": [
        ("_location", True, 'scope'),        # Scope this type is defined in
    ...
    "impl": [
        ("_location", True),
        ("_location", True, "base"),
        ("access", "VARCHAR(32)", True), # Type of inheritance; NULL is indirect
    ],
